...
_NOUN_ED = {
    ...
    "breed", "exceed", "proceed", "succeed", "indeed", "sacred", "beloved", "wretched",
    "naked", "wicked", "crooked", "dogged", "ragged", "rugged", "aged", "learned", "alleged",
    "hundred", "thousand", }

_SAFE_ER = {
    "better", "bitter", "clever", "eager", "proper", "sober", "tender", "utter", "inner",
    "outer", "upper", "lower", "former", "latter", "major", "minor", "senior", "junior",
    "superior", "inferior", "interior", "exterior", "anterior", "posterior", "ulterior",
    "dinner", "summer", "winter", "chapter", "letter", "member", "number", "finger",
    "hunger", "anger", "after", "under", "over", "enter", "water", "paper", "river", "never",
    "ever", "butter", "ladder", "rubber", "copper", "silver", "slipper", "shutter",
    "cucumber", "computer", "teacher", "worker", "player", "builder", "listener", "singer",
    "dancer", "painter", "reader", "leader", "keeper", "maker", "taker", "giver", "lover",
    "helper", "thinker", "believer", "employer", "customer", "container", "prefer", "refer",
    "infer", "confer", "transfer", "differ", "suffer", "offer", "proffer", }

_SAFE_LY = {
    "silly", "jolly", "holly", "bully", "dolly", "folly", "ally", "rally", "belly", "smelly",
    "lovely", "friendly", "ugly", "homely", "comely", "only", "early", "lively", "lonely",
    "ghastly", "heavenly", "earthly", "worldly", "brotherly", "motherly", "fatherly",
    "sisterly", "manly",
...
_VALID_WITHOUT_E = {
    "walk", "talk", "chalk", "milk", "silk", "melt", "belt", "camp", "lamp", "stamp", "help",
    "yelp", "stand", "hand", "land", "band", "send", "tend", "bend", "mend", "need", "feed",
    "seed", "weed", "deed", "greed", "fold", "hold", "cold", "gold", "old", "jump", "lump",
    "pump", "dump", "turn", "burn", "learn", "earn", "work", "park", "mark", "dark", "bark",
    "ask", "mask", "task", "test", "rest", "nest", "west", "find", "kind", "mind", "bind",
    "wind", "long", "song", "strong", "wrong", "look", "book", "cook", "took", "part",
    "start", "heart", "count", "mount", "point", "joint", "print", "paint", "plant", "act",
    "fact", "tract", "pact", "collect", "correct", "direct", "protect", "select", "elect",
    "reflect", "connect", "inspect", "respect", "expect", "import", "report", "support",
    "transport", "present", "consent", "intent", "open", "happen", "listen", "fasten",
    "garden", "sudden", "hidden", "travel", "cancel", "label", "level", "signal", "final",
    "local", "legal", "total", "general", "natural", "normal", "person", "prison", "lesson",
    "kitchen", "chicken", "question", "unquestion", "sudden", "breath", "death", "after",
    "under", "over", "enter", "number", "member", "chapter", "letter", "better", "dinner",
    "summer", "winter", "water", "paper", "river", "never", "little", "middle", "simple",
    "apple", "battle", "bottle", "clean", "weak", "deep", "tall", "small", "full", "dull",
    "cold", "bold", "wild", "mild", "hard", "soft", "fast", "vast", "most", "last", "past",
    "cast", "cost", "lost", "frost", "best", "rest", "west", "must", "just", "dust", "rust",
    "pest", "nest", "crest", "hand", "land", "sand", "band", "wind", "find", "mind", "kind",
    "bond", "pond", "fond", "long", "song", "strong", "wrong", "young", "among", "along",
    "play", "stay", "pray", "tray", "clay", "gray", "away", "nation", "capital", "social",
    "critic", "terror", "classic", "modern", "commun", "organ",
    # -ity root words (prevent over-e-ing)
    "major", "minor", "prior", "author", "senior", "junior", "superior", "inferior",
    "interior", "exterior", "anterior", "posterior", "ulterior", "fatal", "moral", "brutal",
    "sexual", "vital", "mental", "original", "individual", "singular", "plural", "popular",
    "regular", "particular", "familiar", "curious", "generous", "serious", "various",
    "famous", "diverse", "intense", "immense", "obscure", "sincere", "pure", "secure",
    "mature", "obscure", "equal", "dense", "universe", "adverse", "advers", "inequal",
    "serene", "subverse", "obverse", "perverse", "digne", "vain", "prosperous", "ambiguous",
    "dignified", "complex", "triplex", }

# Words that end in a double consonant that IS the root (not a doubling inflection)
_KNOWN_DOUBLE_ROOT = {
    "tall", "small", "full", "dull", "bull", "pull", "will", "well", "bell", "cell", "fell",
    "hell", "tell", "sell", "yell", "kill", "fill", "mill", "bill", "hill", "ill", "ball",
    "call", "fall", "hall", "wall", "roll", "toll", "poll", "mass", "pass", "class", "glass",
    "grass", "press", "dress", "stress", "guess", "miss", "kiss", "loss", "boss", "cross",
    "odd", "add", "egg", "inn", "ebb", }
...
_KNOWN_E_ROOTS = {
    ...
    "lov", "mak", "tak", "giv", "liv", "hav", "bak", "rak", "wak", "wav", "rav", "sav",
    "pav", "cav", "nav", "div", "riv", "giv", "liv", "com", "hom", "som", "rid", "hid",
    "bid", "cub", "tub", "dub", "rub", "vow", "row", "bow", "sow", "mow", "tow",
